    ...
    <section id="recipes" className="py-16 md:py-28 bg-black border-t border-zinc-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          {formulas.map((formula) => (
            ...
            >
              ...
              <div className="hidden md:flex flex-col h-full min-h-[380px] p-6 relative z-10">
                ...
                <button className="w-full py-3 border border-zinc-800 group-hover:border-zinc-600 text-[8px] font-black uppercase tracking-widest transition-all duration-300 text-zinc-600 group-hover:text-white font-mono">
                  Open in Savor →
                </button>
              </div>
            </div>
        ...
        <div className="md:hidden mt-px">
          <button className="w-full py-4 border border-zinc-800 bg-zinc-950 text-[9px] font-black uppercase tracking-widest text-zinc-500 font-mono hover:text-white hover:border-zinc-600 transition-all">
            Open All in Savor →
          </button>
        </div>
