    ...
    <>
      ...
      >
        <a href="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', marginRight: 'auto' }}>
          <img src={logo} alt="Iron Kitchen Inc." style={{ height: 36, transition: 'opacity 0.3s' }} />
        </a>
        ...
        <div className="nav-desktop" style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
          {links.map((l) => (
            <a key={l.label} href={l.href}
              ...
              onMouseLeave={(e) => (e.currentTarget.style.color = scrolled ? C.inkLight : 'rgba(255,255,255,0.7)')}
            >
              {l.label}
            </a>
          ))}
          ...
          <Link to="/store"
            style={{
              ...
              letterSpacing: '0.16em',
              textTransform: 'uppercase',
              color: scrolled ? C.red : 'rgba(255,255,255,0.85)',
              textDecoration: 'none',
              transition: 'color 0.2s',
              display: 'flex', alignItems: 'center', gap: 6,
            }}
            onMouseEnter={(e) => (e.currentTarget.style.color = C.red)}
            onMouseLeave={(e) => (e.currentTarget.style.color = scrolled ? C.red : 'rgba(255,255,255,0.85)')}
          >
            <span style={{ display: 'inline-block', width: 6, height: 6, borderRadius: '50%', background: 'currentColor', flexShrink: 0 }} />
            Store
          </Link>

          <a href="mailto:hello@ironkitcheninc.com"
            style={{
              fontFamily: "'DM Mono', 'IBM Plex Mono', monospace",
              fontSize: 10,
        ...
        <button className="nav-mobile-btn" onClick={() => setMobileOpen(!mobileOpen)}
          style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 10, display: 'none', flexDirection: 'column', gap: 5 }}
        >
          {[0, 1, 2].map((i) => (
            <div key={i} style={{
              width: 22, height: 1.5,
      ...
      {mobileOpen && (
        <div style={{
          ...
          background: C.white, borderBottom: `1px solid ${C.steel}`,
          ...
          >
            <span style={{ display: 'inline-block', width: 6, height: 6, borderRadius: '50%', background: C.red, flexShrink: 0 }} />
            IKI Store
          </Link>
          <a href="mailto:hello@ironkitcheninc.com"
            style={{
...
function Hero() {
  return (
    <section style={{
      minHeight: '100vh', background: C.black, position: 'relative',
      display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', overflow: 'hidden',
    }}>
      <img src={imgHero} alt=""
        style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 30%', opacity: 0.28 }}
      />
      <div style={{
      ...
      <div style={{
        ...
        {['Clemmons, NC', 'Est. MMXXV', 'Batch 01 — 50 Units', 'Made in USA'].map((t, i) => (
          <Label key={i} color="rgba(255,255,255,0.25)">{t}</Label>
        ))}
      </div>
      <div style={{
        position: 'relative', zIndex: 2,
        padding: '0 40px 80px', maxWidth: 1200, width: '100%', alignSelf: 'flex-start', marginTop: 'auto',
        ...
        <h1 style={{
          ...
          fontWeight: 400, fontSize: 'clamp(64px, 13vw, 180px)',
          color: C.white, lineHeight: 0.88, textTransform: 'uppercase',
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 32 }}>
          <p style={{
            ...
            lineHeight: 1.9, maxWidth: 400, margin: 0, letterSpacing: '0.04em',
          }}>
            Professional kitchen tools designed by engineers,<br />made in North Carolina, built to outlast careers.
          </p>
          <div style={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            ...
            <a href="#products"
              ...
              onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.4)'; e.currentTarget.style.color = C.white; }}
      ...
      <div style={{
        ...
        <Label color="rgba(255,255,255,0.2)" style={{ writingMode: 'vertical-rl', letterSpacing: '0.3em' }}>Scroll</Label>
        <div style={{ width: 1, height: 48, background: 'rgba(255,255,255,0.15)' }} />
      </div>
      <style>{`
        @media (max-width: 768px) {
          .hero-top-bar { display: none !important; }
...
function CutBar() {
  const items = ['Made in America', 'Family Owned', 'Batch 01 — 50 Units', 'Clemmons, NC', '304 Stainless Steel', 'NSF Certified', 'FDA Compliant'];
  return (
    <div style={{
      background: C.ink,
      display: 'flex', alignItems: 'center',
      ...
      <style>{`.cutbar::-webkit-scrollbar { display: none; }`}</style>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div style={{
        ...
        <Label style={{ background: product.featured ? C.red : C.steel, color: product.featured ? C.white : C.muted, padding: '3px 10px', fontSize: 9 }}>
          {product.status}
        </Label>
      </div>
      <div style={{
      ...
      <div style={{ padding: '28px 24px 24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <Label color={product.featured ? 'rgba(255,255,255,0.3)' : C.muted} style={{ display: 'block', marginBottom: 16 }}>
          {product.sub}
        </Label>
        <p style={{
          fontFamily: 'system-ui, sans-serif', fontSize: 13,
          color: product.featured ? 'rgba(255,255,255,0.5)' : C.muted,
          lineHeight: 1.75, margin: '0 0 24px', flex: 1,
        }}>
          {product.desc}
        </p>
        <div style={{ marginBottom: 24 }}>
          {product.specs.map((s, i) => (
            <div key={i} style={{
              display: 'flex', justifyContent: 'space-between', alignItems: 'center',
              padding: '7px 0',
              borderTop: `1px solid ${product.featured ? 'rgba(255,255,255,0.06)' : C.steel}`,
            }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          <span style={{
            fontFamily: "'Bebas Neue', 'Barlow Condensed', sans-serif",
            fontSize: 44, color: product.featured ? C.white : C.ink,
          ...
          <Link to={product.href}
            ...
            onMouseLeave={(e) => (e.currentTarget.style.background = product.featured ? C.red : C.ink)}
          >
            Buy Now →
          </Link>
        </div>
    ...
    <section id="products" style={{ background: C.offwhite, padding: '120px 40px' }} className="products-section">
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{
          ...
          paddingBottom: 40, borderBottom: `1px solid ${C.steel}`,
          ...
          <div>
            ...
            <h2 style={{
              fontFamily: "'Bebas Neue', 'Barlow Condensed', sans-serif",
              fontWeight: 400, fontSize: 'clamp(52px, 7vw, 88px)',
              color: C.ink, margin: 0, lineHeight: 0.88, letterSpacing: '0.01em',
            }}>
              The Equipment.
            </h2>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 16 }} className="products-sub-wrap">
            <Label color={C.muted} style={{ maxWidth: 280, lineHeight: 2.1, textAlign: 'right' }} className="products-sub">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 2 }} className="product-grid">
          {PRODUCTS.map((p) => <ProductCard key={p.id} product={p} />)}
        </div>
      </div>
      <style>{`
        @media (max-width: 960px) {
          .product-grid { grid-template-columns: 1fr !important; gap: 2px !important; }
          .products-sub-wrap { align-items: flex-start !important; }
          .products-sub { text-align: left !important; }
        }
        @media (max-width: 768px) {
          .products-section { padding: 80px 20px !important; }
          .products-header { margin-bottom: 40px !important; padding-bottom: 32px !important; flex-direction: column; align-items: flex-start !important; }
        }
      `}</style>
    </section>
  );
...
function Specs() {
  return (
    <section id="specs" style={{ background: C.white, padding: '120px 40px', borderTop: `1px solid ${C.steel}` }} className="specs-section">
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }} className="specs-grid">
          <div style={{
            background: C.tile, border: `1px solid ${C.steel}`,
            ...
            <img src={imgSchematics} alt="IKX-1 Schematics" style={{ maxWidth: '100%', position: 'relative', filter: 'contrast(1.1)' }} />
          ...
          <div>
            ...
            <h2 style={{
              fontFamily: "'Bebas Neue', 'Barlow Condensed', sans-serif",
              fontWeight: 400, fontSize: 'clamp(48px, 5vw, 72px)',
              color: C.ink, margin: '0 0 40px', lineHeight: 0.9, letterSpacing: '0.01em',
            }}>
            ...
            <div style={{ marginBottom: 40 }}>
              {[
                ...
                <div key={i} style={{
                  display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  padding: '13px 0', borderBottom: `1px solid ${C.steel}`,
                }}>
                  <Label color={C.mid}>{s.k}</Label>
                  <span style={{ fontFamily: 'system-ui, sans-serif', fontSize: 13, color: C.ink, textAlign: 'right', maxWidth: '55%' }}>
                    {s.v}
                  </span>
                </div>
              ))}
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              <a href="/blueprints/press-blueprint.pdf" target="_blank"
                style={{
                  display: 'inline-flex', alignItems: 'center', gap: 10,
                  padding: '13px 24px', border: `1px solid ${C.steel}`,
                  color: C.ink,
                  fontFamily: "'DM Mono', 'IBM Plex Mono', monospace",
                  fontSize: 10, letterSpacing: '0.18em', textTransform: 'uppercase',
                  textDecoration: 'none', transition: 'all 0.2s',
                }}
                onMouseEnter={(e) => { e.currentTarget.style.background = C.ink; e.currentTarget.style.color = C.white; e.currentTarget.style.borderColor = C.ink; }}
                onMouseLeave={(e) => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = C.ink; e.currentTarget.style.borderColor = C.steel; }}
              >
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }} className="about-grid">
          <div>
            ...
            <h2 style={{
              fontFamily: "'Bebas Neue', 'Barlow Condensed', sans-serif",
              fontWeight: 400, fontSize: 'clamp(52px, 6vw, 80px)',
              color: C.white, margin: '0 0 40px', lineHeight: 0.9, letterSpacing: '0.01em',
            }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              {[
                ...
                <p key={i} style={{
                  ...
                  paddingLeft: 20, borderLeft: '1px solid rgba(255,255,255,0.1)',
                }}>
                  {text}
                </p>
              ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            {[
              { n: '01', title: 'Made in America', body: 'Designed and manufactured in Clemmons, NC. Not a marketing claim — a commitment.' },
              { n: '02', title: 'Serious Materials', body: 'Food-grade stainless steel, machined to tight tolerances. Nothing cheap, nothing that wears out.' },
              { n: '03', title: 'Family Owned', body: 'No investors, no shortcuts. Two brothers who put their name on everything they ship.' },
              { n: '04', title: 'Built to Last Generations', body: 'The kind of tool you hand down. Made to outlast trends, kitchens, and careers.' },
            ].map((item) => (
              <div key={item.n}
                style={{
                  background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)',
                  padding: '28px', display: 'flex', gap: 24, transition: 'background 0.2s',
                }}
                onMouseEnter={(e) => (e.currentTarget.style.background = 'rgba(255,255,255,0.06)')}
                onMouseLeave={(e) => (e.currentTarget.style.background = 'rgba(255,255,255,0.03)')}
              >
                <Label color="rgba(255,255,255,0.15)" style={{ fontSize: 13, flexShrink: 0, marginTop: 2 }}>{item.n}</Label>
                <div>
                  <div style={{
                    fontFamily: "'DM Mono', 'IBM Plex Mono', monospace",
                  ...
                  <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 13, color: 'rgba(255,255,255,0.35)', lineHeight: 1.7, margin: 0 }}>
                    {item.body}
                  </p>
                </div>
              </div>
...
const FAQS = [
  ...
  {
    q: "How do I order?",
    a: "Visit our store to select your press and accessories. Batch 01 is limited to 50 units. You can also email hello@ironkitcheninc.com directly.",
  },
];
  ...
  return (
    <section id="faq" style={{ background: C.white, padding: '120px 40px', borderTop: `1px solid ${C.steel}` }} className="faq-section">
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{
          fontFamily: "'Bebas Neue', 'Barlow Condensed', sans-serif",
          fontWeight: 400, fontSize: 'clamp(52px, 6vw, 76px)',
          color: C.ink, margin: '0 0 64px', lineHeight: 0.9, letterSpacing: '0.01em',
        }} className="faq-title">
          ...
          <div key={i} style={{ borderBottom: `1px solid ${C.steel}` }}>
            ...
            >
              <span style={{
                ...
                color: open === i ? C.red : C.ink, lineHeight: 1.4, transition: 'color 0.2s',
              }}>
                {item.q}
              </span>
              <div style={{
            ...
            <div style={{ overflow: 'hidden', maxHeight: open === i ? 300 : 0, transition: 'max-height 0.3s ease' }}>
              <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 14, color: C.muted, lineHeight: 1.85, paddingBottom: 24, margin: 0 }}>
                {item.a}
              </p>
            </div>
          </div>
        ...
        <div style={{
          marginTop: 64, background: C.ink, padding: '40px',
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          ...
          <div>
            ...
            <div style={{
              fontFamily: "'Bebas Neue', 'Barlow Condensed', sans-serif",
              fontSize: 28, color: C.white, letterSpacing: '0.02em',
            }}>
              Batch 01 — 50 Units.
            </div>
          </div>
          <div style={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            <Link to="/store"
              style={{
                padding: '13px 28px', background: C.red, color: C.white,
                fontFamily: "'DM Mono', 'IBM Plex Mono', monospace",
                fontSize: 10, letterSpacing: '0.2em', textTransform: 'uppercase',
                textDecoration: 'none', transition: 'background 0.2s', flexShrink: 0,
                display: 'inline-block',
...
function Footer() {
  return (
    <footer style={{ background: C.black, padding: '64px 40px 32px', borderTop: '1px solid #1a1a18' }} className="footer-section">
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{
          display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: 60,
          ...
          <div>
            <Label color="rgba(255,255,255,0.3)" style={{ display: 'block', marginBottom: 20 }}>Navigate</Label>
            {[
              { label: 'Products', href: '#products' },
            ...
            <Link to="/store"
              style={{
                display: 'block', marginBottom: 12,
                fontFamily: 'system-ui, sans-serif', fontSize: 13,
                color: 'rgba(196,30,30,0.6)', textDecoration: 'none', transition: 'color 0.2s',
              }}
              onMouseEnter={(e) => (e.currentTarget.style.color = C.red)}
              onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(196,30,30,0.6)')}
            >
              IKI Store
            </Link>
          </div>
          <div>
            <Label color="rgba(255,255,255,0.3)" style={{ display: 'block', marginBottom: 20 }}>Contact</Label>
            <a href="mailto:hello@ironkitcheninc.com"
              style={{
                display: 'block', marginBottom: 12,
                fontFamily: 'system-ui, sans-serif', fontSize: 13,
            ...
            <div style={{ marginTop: 24, display: 'flex', gap: 4 }}>
              {['NSF', 'FDA', 'USA'].map((b) => (
                <span key={b} style={{
                  ...
                  fontFamily: "'DM Mono', 'IBM Plex Mono', monospace",
                  fontSize: 9, letterSpacing: '0.15em', color: 'rgba(255,255,255,0.2)',
                }}>
                  {b}
                </span>
              ))}
