...
const SHOP_BASE = 'https://ironkitcheninc.com/collections/all';
...
function AddToCartBtn({ url, label = 'Place Order', accent = false }) {
    return (
        <a
            ...
            className={`group relative overflow-hidden font-black uppercase tracking-widest text-[9px] px-6 py-3 transition-all duration-300 flex items-center justify-center gap-2 ${accent
                ...
                <div className="mb-1 grid md:grid-cols-2 gap-px bg-zinc-900">
                    ...
                    <div className="bg-zinc-950 relative overflow-hidden flex items-center justify-center min-h-[380px] md:min-h-[520px]">
                        ...
                        <img
                            ...
                            style={{ filter: 'brightness(0.75) contrast(1.05) grayscale(0.3)' }}
                        />
                        {/* Badge */}
                ...
                <div className="mb-16 bg-zinc-950 border border-zinc-900 border-t-0">
                    ...
                    <div className="p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        ...
                        <div className="shrink-0 w-24 h-24 flex items-center justify-center">
                            <img src={imgBundle} alt="Patty Board Bundle" className="w-full h-full object-contain" style={{ filter: 'brightness(0.75) contrast(1.05) grayscale(0.3)' }}
                            />
                        </div>
